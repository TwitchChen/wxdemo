...
class SHA1(object):
    ...
    def getSHA1(self, token, timestamp, nonce, encrypt):
        ...
        try:
            ...
            self.app.logger.error('wechat encryption/decryption error')
...
<Nonce><![CDATA[%(nonce)s]]></Nonce>
    ...
    def extract_get_msg(self,decryp_xml):
        """
        对解密后的xml数据处理
        :param decryp_xml: 待提取的xml字符串
        :return:
        """
        try:
            ...
            msg_id = xml_tree.find("MsgId")
            return touser_name.text,fromuser_name.text,msg_type.text,content.text,msg_id.text
        except Exception as e:
            print(e)
            self.app.logger.error('wechat encryption/decryption error')
            return  None
...
class WXBizMsgCrypt(object):
    ...
    def __init__(self,sToken,sEncodingAESKey,sAppId,app):
        try:
    ...
    def EncryptMsg(self, sReplyMsg, sNonce, timestamp = None):
        ...
        pc = Prpcrypt(self.key,app=self.app)
